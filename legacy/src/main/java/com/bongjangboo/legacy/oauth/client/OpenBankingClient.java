...
import com.bongjangboo.legacy.oauth.client.request.TransactionRequest;
import com.bongjangboo.legacy.oauth.client.response.AccountInfoResponse;
import com.bongjangboo.legacy.oauth.client.response.MockTransactionResponse;
import com.bongjangboo.legacy.oauth.client.response.OpenBankingTokenResponse;
import com.bongjangboo.legacy.oauth.client.response.TransactionResponse;
